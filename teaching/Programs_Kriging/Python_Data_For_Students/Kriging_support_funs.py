...
The following functions are provided:
    ...
    1. Fit_model_to_data: Fit a parametric model to an experimental semivariogram
    2. From_List_to_grid: Take a list and a NaN-filled matrix, embed the list
        entries into the matrix
    3. Write_list_in_grid: Write a list directly into a grid, similar to 
        From_List_to_grid but a slightly different use case
    4. From_grid_to_list: Take a grid and unravel the data back into a list
    5. Make_comparative_interpolation: Generate interpolation results with 
        alternative methods
    6. Make_Distance_matrix: Take a list of coordinates and create the pairwise
        distances
...
"""
5. Make_comparative_interpolation ---------------------------------------------
"""
