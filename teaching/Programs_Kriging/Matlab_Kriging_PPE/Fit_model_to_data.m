...
% Create weights for the objective function. This is just an ad hoc approach
% reflecting the idea that the error should be less important far beyond
% the actual range and therefore for values of the semivariance close to
% the sill.  Please note that there are better and stochastically justified
% versions in the textbooks from Cressie or Chiles & Delfiner
% Here make them inversely proportional to the squareroot of the lag and 
% smaller near the sill
